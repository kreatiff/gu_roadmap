...
export const config = {
  ...
  ai: {
    endpoint: process.env.AI_PROJECT_ENDPOINT || process.env.AI_FOUNDRY_ENDPOINT || '',
    apiKey: process.env.AI_PROJECT_API_KEY || process.env.AI_FOUNDRY_API_KEY || '',
    deployment: process.env.AI_DEPLOYMENT_NAME || process.env.AI_FOUNDRY_DEPLOYMENT || 'gpt-4.1',
    apiVersion: process.env.AI_API_VERSION || process.env.AI_FOUNDRY_API_VERSION || '2024-02-01',
    configured: Boolean(
